...
\paragraph{Shared entry point (Figure~\ref{fig:spa-dual}).}
...
metadata at version \code{0.5.1}.  The manuscript describes the artifact
frozen at PyPI version \code{0.5.1} (Zenodo DOI
\url{https://doi.org/10.5281/zenodo.21329428}, GitHub tag \code{v0.5.1});
the repository \code{main} branch continues maintenance post-publication
with later minor versions, but the SPA table numbers, configuration, and
empirical sample in this submission are bit-identical to \code{0.5.1}.
